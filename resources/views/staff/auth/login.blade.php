...
@section('content')
    <div class="page-wrapper default-version">
        <div class="form-area bg_img" data-background="{{asset('public/assets/staff/images/1.jpg')}}">
            <div class="form-wrapper">
                ...
                <form action="{{ route('staff.login')}}"  method="POST" class="cmn-form mt-30" onsubmit="return submitUserForm();">
                    @csrf
